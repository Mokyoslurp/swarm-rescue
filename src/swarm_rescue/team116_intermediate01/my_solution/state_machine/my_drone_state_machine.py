...
class MyDroneStateMachine(DroneTemplate):
    ...
    def control(self) -> CommandsDict:
        ...
        # )
        self.pose = DronePose(np.asarray(self.true_position()), self.true_angle())
...
def main():
    the_map = MapIntermediate01(drone_type=MyDroneStateMachine)
